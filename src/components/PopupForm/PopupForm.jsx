                ...
                <div className={css.selectGroup}>
                    ...
                    <ul className={css.optionsList}>
                        ...
                        <li>
                            <label
                                className={`${css.option} ${
                                    selectedOptions.includes("Cosmetics")
                                        ? css.selected
                                        : ""
                                }`}>
                                <input
                        ...
                        <li>
                            <label
                                ...
                                <input
                                    ...
                                    onChange={() =>
                                        handleOptionChange("Electronics")
                                    }
                                />
                                Electronics
                            </label>
                        ...
                        <li>
                            <label
                                className={`${css.option} ${
                                    selectedOptions.includes("Other sectors")
                                        ? css.selected
                                        : ""
                                }`}>
                                <input
                                    ...
                                    onChange={() =>
                                        handleOptionChange("Other sectors")
                                    }
                                />
                                Other sectors
                            </label>
                        ...
                        <button
                            ...
                            <svg className={css.callBtnIcon}>
                                ...
                                <use
                                    ...
                                    stroke="url(#iconGradient)"></use>
                            </svg>
                        </button>

                        <p className={css.callBtnDescr}>
                            Or you can Book a <span>Free Demo Call</span> at
                            convenient time
                        </p>
                    </div>
